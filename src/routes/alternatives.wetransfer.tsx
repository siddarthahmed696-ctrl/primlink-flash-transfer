...
export const Route = createFileRoute("/alternatives/wetransfer")({
  head: () => ({
    meta: [
      { title: "Best WeTransfer Alternative — 10 GB Free, No Sign-Up | Primlink" },
      {
        name: "description",
        content:
          "Looking for a WeTransfer alternative? Primlink Transfer offers 10 GB free (vs WeTransfer's 2 GB), no account required, and instant worldwide sharing. Try it now.",
      },
      {
        property: "og:title",
        content: "Best WeTransfer Alternative — 10 GB Free, No Sign-Up | Primlink",
      },
      {
        property: "og:description",
        content:
          "Send up to 10 GB for free with Primlink. No account, no waiting — just drop files and share the link instantly.",
      },
      ...
      <main className="relative">
        ...
        <section className="relative mx-auto max-w-6xl px-6 pt-16 pb-10 lg:pt-24 text-center">
          ...
          <p className="mt-6 text-lg text-muted-foreground max-w-2xl mx-auto">
            Primlink gives you <strong>10 GB free</strong> — 5× more than WeTransfer's 2 GB free tier. No sign-up, no email verification, no limits on downloads. Just drop files and share.
          </p>
        ...
        <section id="comparison" className="relative mx-auto max-w-5xl px-6 py-20">
          <h2 className="text-3xl sm:text-4xl font-bold text-center">
            Primlink vs <span className="text-gradient-red">WeTransfer</span>
          </h2>
          <p className="mt-3 text-muted-foreground text-center max-w-xl mx-auto">
            Why users switch to Primlink for free file transfers.
          </p>
          ...
          <div className="mt-10 rounded-2xl border border-border overflow-hidden bg-card">
            <div className="grid grid-cols-[1.5fr_1fr_1fr] gap-4 px-6 py-4 text-sm font-medium border-b border-border bg-surface">
              <div>Feature</div>
              <div className="text-center text-primary">Primlink</div>
        ...
        <section className="relative mx-auto max-w-6xl px-6 py-16">
          ...
          <div className="mt-12 grid md:grid-cols-3 gap-5">
            <ReasonCard
              ...
              body="WeTransfer caps free transfers at 2 GB. Primlink lets you send up to 10 GB without paying a cent — perfect for video editors, designers, and anyone with large files."
            />
            <ReasonCard
        ...
        <section className="relative mx-auto max-w-3xl px-6 py-16">
          ...
          <div className="space-y-4">
            <FaqItem
              question="Is Primlink really a free WeTransfer alternative?"
              answer="Yes. Primlink is completely free for transfers up to 10 GB. There are no hidden fees, no credit card required, and no subscription upsells."
            />
            <FaqItem
            ...
            <FaqItem
              ...
              answer="Primlink uses a global CDN to deliver files quickly from the nearest edge location. Most users see comparable or faster download speeds than traditional transfer services."
            />
            <FaqItem
        ...
        <section className="relative mx-auto max-w-4xl px-6 py-16 text-center">
          <div className="rounded-2xl border border-border bg-card p-8 sm:p-12">
            ...
            <p className="mt-4 text-muted-foreground max-w-lg mx-auto">
              Join thousands of users who moved to Primlink for bigger free limits and zero friction.
            </p>
            <div className="mt-8">
              <Link
                to="/"
