...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "V Move You — Send big files fast, worldwide" },
      {
        name: "description",
        content:
      ...
      { property: "og:description", content: "V Move You Fast Transfer allows secure, global sharing of large files up to 5GB." },
      { name: "twitter:description", content: "V Move You Fast Transfer allows secure, global sharing of large files up to 5GB." },
