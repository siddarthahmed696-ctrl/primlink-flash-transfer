  ...
  head: () => ({
    meta: [
      ...
      { title: "V Move You — Send files up to 800 MB free" },
      {
        name: "description",
        content:
          "Upload up to 800 MB and share a download link instantly. Free, fast, secure file transfer by V Move You.",
      },
      { name: "theme-color", content: "#0a1226" },
      { property: "og:title", content: "V Move You — Send files up to 800 MB free" },
      { property: "og:description", content: "Upload up to 800 MB and share a secure download link instantly." },
      { name: "twitter:title", content: "V Move You — Send files up to 800 MB free" },
      { name: "twitter:description", content: "Upload up to 800 MB and share a secure download link instantly." },
