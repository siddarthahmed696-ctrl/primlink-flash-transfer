...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "UTransfer Fast Transfer allows secure, global sharing of large files up to 5GB." },
      { property: "og:description", content: "UTransfer Fast Transfer allows secure, global sharing of large files up to 5GB." },
      { name: "twitter:description", content: "UTransfer Fast Transfer allows secure, global sharing of large files up to 5GB." },
