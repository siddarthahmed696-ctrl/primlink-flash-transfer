  ...
  head: () => ({
    meta: [
      { title: "Blog — UTransfer" },
      {
        name: "description",
        content:
          "Guides, product news and deep dives from the UTransfer team on sending big files, security and Primlink.",
      },
    ],
  }),
  component: BlogPage,
...
const posts = [
  ...
  },
  {
    ...
    body: [
      ...
      "UTransfer is sponsored by Primlink — the platform that powers our infrastructure. That sponsorship is the entire business model. No upsells inside the product, no dark patterns, no email harvesting. The Primlink panel you see while uploading is the ad — that is what keeps the lights on.",
  ...
  },
  {
    ...
    body: [
      ...
      "If you need stronger guarantees — end-to-end encryption, expiring passwords, audit trails — the Primlink platform offers them for teams. UTransfer remains the free, no-account front door.",
    ],
  },
];
