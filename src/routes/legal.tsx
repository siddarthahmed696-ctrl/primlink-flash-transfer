    ...
    <div className="min-h-screen flex flex-col bg-background text-foreground">
      ...
      <main className="flex-1 mx-auto max-w-3xl w-full px-6 py-12 prose prose-invert">
        ...
        <p className="mt-4 text-muted-foreground">
          UTransfer is a file-transfer service operated by Primlink. By using this site you agree
        ...
        <p className="mt-2 text-muted-foreground">
          To the maximum extent permitted by law, UTransfer and Primlink are not liable for any
        ...
        <p className="mt-2 text-muted-foreground">
          For legal inquiries, contact us via the Primlink website.
        </p>
      </main>
      <SiteFooter />
    </div>
